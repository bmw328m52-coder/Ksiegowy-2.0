...
export default function MaterialsSection({
  ...
  const missingPrice = materials.some((m) => m.unit_price_gross === null);
    ...
    <section className="mt-4 rounded-xl border border-zinc-200 bg-white p-4">
      ...
      {materials.length === 0 ? (
        ...
        <>
          ...
          <div className="flex items-baseline justify-between border-t border-zinc-100 pt-3 mb-3">
            <span className="text-xs text-zinc-500">
              Suma materiałów{missingPrice && " (bez pozycji bez ceny)"}
            </span>
